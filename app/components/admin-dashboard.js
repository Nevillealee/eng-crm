                  ...
                  <Stack spacing={2}>
                    ...
                    {filteredEngineers.map((engineer) => (
                      <EngineerCard
                        ...
                        availabilityColor={
                          availabilityColorByValue[engineer.availabilityStatus] || "default"
                        }
                        ...
                        onBeginEditComp={() => beginEditEngineerComp(engineer.id)}
                        onUpdateEngineerDraft={updateEngineerDraft}
                        onSaveEngineerComp={() => saveEngineerCompensation(engineer.id)}
                        onCancelEditComp={() => cancelEditEngineerComp(engineer.id)}
                      />
                    ))}
                  </Stack>
                </Paper>
